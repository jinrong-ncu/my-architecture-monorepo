...
const columns: ProColumnData[] = [
    ...
    },
    {
        ...
        switchConfig: {
            activeText: '启用',
            inactiveText: '封禁',
            onChange: (val: any, row: any) => console.log('修改账号状态:', val, row.name)
        }
    },
    {
        title: '入职时间',
        ...
        operation: [
            {
                label: '查看',
                icon: 'icon-eye',
                onClick: (row: any) => console.log('查看:', row.name)
            },
            {
                label: '编辑',
                icon: 'icon-edit',
                onClick: (row: any) => console.log('编辑:', row.name)
            },
            {
                label: '封号',
                icon: 'icon-stop',
                disabled: (row: any) => !row.accountEnabled,
                onClick: (row: any) => console.log('封号:', row.name)
            },
            {
                label: '删除',
                icon: 'icon-delete',
                onClick: (row: any) => console.log('删除:', row.name)
            }
        ]
    }
];
